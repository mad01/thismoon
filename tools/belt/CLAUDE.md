...
belt/
  ...
  internal/
    ...
    hint/             - the hints (prefer-csl, commit-policy, kof-assertions, kof-consult, kof-deposit, agent-memory, humanizer-check) + csl index lookup, response parsing, session dedupe
