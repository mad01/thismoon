...
// established. It lives in a test file because only the kind test needs it:
// a real deployment applies deploy/base, and the instance's service account
// has no right to write definitions.
