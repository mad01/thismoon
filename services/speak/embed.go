// Package speak holds the speak component identity: the embedded operating
// doc and the mechanical facts it renders with. internal/cli,
// internal/mcpserver, and internal/ttsclient all read from here, so the doc,
