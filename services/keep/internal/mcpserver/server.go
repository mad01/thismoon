...
// a thin HTTP call to a running `keep serve`, which owns the store and resolves
...
type Config struct {
	Port    int
	BaseURL string // display/link URL shown to the user (e.g. http://keep.this); falls back to the API URL
}
